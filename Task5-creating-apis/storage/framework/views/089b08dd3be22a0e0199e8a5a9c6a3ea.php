...
<div class="container">
        ...
        <div class="card" style="width: 18rem; ">
                <img src="<?php echo e(asset("storage/$product->image")); ?>" class="card-img-top" height="200" style="object-fit: contain;">
                <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/B082EAC082EA89E4/ITI ICC/Laravel/Labs/Task3-form-validation-and-using-resource-controller/resources/views/products/show.blade.php ENDPATH**/ ?>