...
<div class="container">
        ...
        <div class="card" style="width: 18rem; ">
                <div class="card-body">
                        <img src="<?php echo e(asset("images/$category->image")); ?>" class="card-img-top" height="200" style="object-fit: contain;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/B082EAC082EA89E4/ITI ICC/22- Laravel/Labs/Task3-form-validation-and-using-resource-controller/resources/views/categories/show.blade.php ENDPATH**/ ?>